...
function DeviceBadge({ type }: { type?: string }) {
  ...
  const config: Record<string, { icon: string; bg: string; text: string }> = {
    desktop: { icon: 'PC', bg: 'bg-blue-50', text: 'text-blue-600' },
    mobile: { icon: 'MB', bg: 'bg-purple-50', text: 'text-purple-600' },
    tablet: { icon: 'TB', bg: 'bg-indigo-50', text: 'text-indigo-600' },
    bot: { icon: 'BT', bg: 'bg-gray-100', text: 'text-gray-600' },
  };
