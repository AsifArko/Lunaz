...
// Tab icons mapping
const TabIcons: Record<SettingsTabId, React.ReactNode> = {
  general: (
...
export function SettingsTabs({ tabs, activeTab, onTabChange }: SettingsTabsProps) {
  return (
    <div className="border-b border-gray-200 mb-6">
      <nav
        className="flex gap-6 overflow-x-auto scrollbar-hide pb-px"
      ...
      >
        {tabs.map((tab) => (
          <button
            ...
            className={`py-3 text-sm font-medium transition-colors whitespace-nowrap flex items-center gap-2 border-b-2 -mb-px shrink-0 ${
              activeTab === tab.id
