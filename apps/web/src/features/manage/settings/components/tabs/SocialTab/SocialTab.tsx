...
interface SocialTabProps {
  ...
  onChange: (v: SocialSettings | ((prev: SocialSettings) => SocialSettings)) => void;
  onSave: () => Promise<void>;
  isSaving: boolean;
}
...
export function SocialTab({ social: socialSettings, onChange, onSave, isSaving }: SocialTabProps) {
