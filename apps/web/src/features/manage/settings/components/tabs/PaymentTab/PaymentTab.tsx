...
interface PaymentTabProps {
  ...
  onPaymentChange: (v: PaymentSettings | ((prev: PaymentSettings) => PaymentSettings)) => void;
  onGatewaysChange: (v: PaymentGateways | ((prev: PaymentGateways) => PaymentGateways)) => void;
  onSave: () => Promise<void>;
  isSaving: boolean;
}
...
export function PaymentTab({
  ...
  const updatePayment = (key: keyof PaymentSettings, value: unknown) => {
    onPaymentChange((prev) => ({ ...prev, [key]: value }));
  };
