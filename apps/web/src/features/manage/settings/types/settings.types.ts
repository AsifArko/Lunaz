...
// Flattened API payload - backend accepts/returns flat object with nested business, social, etc.
export type SettingsApiPayload = StoreSettings & {
  business?: Partial<BusinessInfo>;
  social?: Partial<SocialSettings>;
  notifications?: Partial<NotificationSettings>;
  paymentSettings?: Partial<PaymentSettings>;
  gateways?: Partial<PaymentGateways>;
};
