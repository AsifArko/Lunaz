      ...
      <header className="sticky top-0 z-30 bg-white border-b border-slate-200/80">
        <Container>
          <div className="flex items-center h-16 gap-8">
            {/* Logo */}
            <Link to="/" className="font-serif text-2xl font-medium text-slate-900 tracking-tight flex-shrink-0">
              Lunaz
            </Link>
        ...
        <Container>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12">
            <div className="col-span-2 md:col-span-1">
              <Link to="/" className="font-serif text-2xl font-medium text-slate-900 tracking-tight">
                Lunaz
              </Link>
              <p className="mt-4 text-sm text-slate-500 leading-relaxed text-body">
                Curated lifestyle and home décor for modern living.
              </p>
            </div>
            <div>
              <h4 className="heading-sub text-slate-900 mb-5">Shop</h4>
              <ul className="space-y-3">
                <li><Link to="/categories" className="text-sm text-slate-500 hover:text-slate-900 transition-colors">Categories</Link></li>
                <li><Link to="/products" className="text-sm text-slate-500 hover:text-slate-900 transition-colors">All Products</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="heading-sub text-slate-900 mb-5">Account</h4>
              <ul className="space-y-3">
                <li><Link to="/account" className="text-sm text-slate-500 hover:text-slate-900 transition-colors">My Account</Link></li>
                <li><Link to="/account/orders" className="text-sm text-slate-500 hover:text-slate-900 transition-colors">Orders</Link></li>
                <li><Link to="/cart" className="text-sm text-slate-500 hover:text-slate-900 transition-colors">Cart</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="heading-sub text-slate-900 mb-5">Support</h4>
              <ul className="space-y-3">
                <li><a href="mailto:hello@lunaz.store" className="text-sm text-slate-500 hover:text-slate-900 transition-colors">Contact Us</a></li>
              </ul>
            </div>
          </div>
          <div className="mt-12 pt-8 border-t border-slate-100">
            <p className="text-xs text-slate-400 text-center tracking-wide">
              © {new Date().getFullYear()} Lunaz. All rights reserved.
            </p>
          </div>
        </Container>
      </footer>
