...
const products: ProductSeed[] = [
  ...
  // ========== HOME DECOR - Candles & Holders ==========
  {
    ...
    variants: [
      ...
      { name: "Eucalyptus Mint", sku: "SWAC-EUC", stock: 35, attributes: { scent: "Eucalyptus & Peppermint" } },
      { name: "Vanilla Amber", sku: "SWAC-VAN", stock: 45, attributes: { scent: "Vanilla & Amber" } },
      { name: "Citrus Grove", sku: "SWAC-CIT", stock: 30, attributes: { scent: "Orange & Bergamot" } },
    ],
    imageCount: 5,
  },
  {
